...
// module
exports.push([module.i, "body {\n  height: 100vh;\n  background: #AF458E;\n  background: -moz-linear-gradient(top, #AF458E 0%, #8272d8 50%, #c1cae5 100%);\n  background: linear-gradient(to bottom, #AF458E 0%, #8272d8 50%, #c1cae5 100%); }\n\n.form {\n  background-color: #ffffff;\n  border: 1px solid #c7c7c7;\n  display: flex;\n  flex-direction: column;\n  font-family: Arial, Helvetica, sans-serif;\n  font-size: 14px;\n  justify-content: center;\n  margin: 100px auto;\n  max-width: 600px;\n  min-height: 200px;\n  padding: 50px; }\n  .form label {\n    color: #8a3770;\n    font-weight: bold;\n    margin: 10px 0; }\n\ndiv {\n  display: flex;\n  flex-direction: column;\n  font-family: Arial, Helvetica, sans-serif;\n  font-size: 14px; }\n\n#fieldValidation {\n  font-size: 12px;\n  font-style: italic; }\n\n.input {\n  border: 1px solid #c7c7c7;\n  font-family: Arial, Helvetica, sans-serif;\n  padding: 5px;\n  width: 100%; }\n\n.invalid-input {\n  border: 1px solid #a81e49;\n  font-family: Arial, Helvetica, sans-serif;\n  padding: 5px;\n  width: 100%; }\n", ""]);
...
// CONCATENATED MODULE: ./src/Field.js
...
function (_Field) {
  ...
  _createClass(PhoneField, [{
    key: "validate",
    value: function validate() {
      return !this.required && !this.value || _get(_getPrototypeOf(PhoneField.prototype), "validate", this).call(this) && this.value.match('\\+\\d{5} \\d{7}');
    }
  }]);
...
function (_Field2) {
  ...
  function DateField() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(DateField).apply(this, arguments));
  }

  _createClass(DateField, [{
    key: "validate",
    value: function validate() {
      return !this.required && !this.value || _get(_getPrototypeOf(DateField.prototype), "validate", this).call(this) && this.value.match('^(?:(?:31(\\/|-|\\.)(?:0?[13578]|1[02]))\\1|(?:(?:29|30)(\\/|-|\\.)(?:0?[1,3-9]|1[0-2])\\2))(?:(?:1[6-9]|[2-9]\\d)?\\d{2})$|^(?:29(\\/|-|\\.)0?2\\3(?:(?:(?:1[6-9]|[2-9]\\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00))))$|^(?:0?[1-9]|1\\d|2[0-8])(\\/|-|\\.)(?:(?:0?[1-9])|(?:1[0-2]))\\4(?:(?:1[6-9]|[2-9]\\d)?\\d{2})$');
    }
  }]);
...
/*#__PURE__*/
function (_Field3) {
  _inherits(TimeField, _Field3);

  function TimeField() {
    _classCallCheck(this, TimeField);

    return _possibleConstructorReturn(this, _getPrototypeOf(TimeField).apply(this, arguments));
  }

  _createClass(TimeField, [{
    key: "validate",
    value: function validate() {
      return !this.required && !this.value || _get(_getPrototypeOf(TimeField.prototype), "validate", this).call(this) && this.value.match('^([0-9]|0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$');
    }
  }]);
